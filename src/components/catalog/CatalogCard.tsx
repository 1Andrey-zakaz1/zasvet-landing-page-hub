  ...
  return (
    <div className="rounded-xl border border-zasvet-gold/30 bg-zasvet-gray/10 shadow-lg overflow-hidden min-h-[270px] flex flex-col transition-transform hover:scale-105 hover:shadow-xl">
      <div className="p-4 flex-grow flex flex-col">
        <h3 className="font-bold text-lg mb-2 text-zasvet-gold">{fixture.name}</h3>
        ...
        <div className="flex items-center justify-between mt-auto">
          <div className="text-base text-zasvet-gold font-bold">{fixture.price.toLocaleString("ru-RU")} ₽</div>
          <Button 
            variant="gold" 
            size="sm"
            className="font-semibold"
            disabled={!fixture.availability}
          >
            {fixture.availability ? "В наличии" : "Нет в наличии"}
          </Button>
        </div>
      </div>
    </div>
