...
const products: Product[] = [
  ...
  },
  {
    id: 4,
    name: 'Серия "Гармония"',
    description: "Офисные светильники для потолков типа \"Армстронг\" или для накладного монтажа. Рассеиватель микропризма. Светильник укомплектован российским драйвером.",
